# Hi, I'm Varsha S Panicker 👋

### Computer Science & Engineering Graduate | Software Development • AI/ML • Full-Stack

I build practical software solutions across **artificial intelligence, web development, 
computer vision, and blockchain** — from AI-assisted healthcare applications to digital 
ownership verification and full-stack platforms.

📍 India &nbsp;•&nbsp; 🎓 B.Tech Computer Science & Engineering &nbsp;•&nbsp; 📄 IEEE Published
...
AI-assisted digital artwork ownership and authenticity verification using **DWT-based 
invisible watermarking, blockchain, BLIP, OCR, perceptual hashing, and tamper detection**.

`Python` `Flask` `Blockchain` `Web3.py` `MongoDB` `OpenCV` `PyTorch`

📄 [IEEE Publication](https://ieeexplore.ieee.org/document/11527717) &nbsp;•&nbsp; 🔒 Source currently private
...
`Python` `Flask` `OCR` `AI/ML` `Data Analysis`
...
I'm interested in opportunities and collaborations across **Software Development, AI/ML,
...
<sub>Always learning, building, and exploring better ways to turn ideas into working software.</sub>
